...
class Sentence {
	 ...
	 * @param {Node} tree The full tree to get the parent node from.
	...
	setParentAttributes (parentNode, tree, setParentNode = false) {
		 ...
		 * Only used for position-based highlighting in sub-blocks.
		 * @type {string}
		 */
		this.parentAttributeId = node.attributeId || ''
		/**
		 * Whether the parent node is the first section of a sub-block.
