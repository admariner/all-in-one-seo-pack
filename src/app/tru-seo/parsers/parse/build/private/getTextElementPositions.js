...
export default function getTextElementPositions (node, textElements, startOffset = -1) {
	...
	if (0 === textElements.length || !node.sourceCodeLocation) {
		return textElements
	}
	 ...
	 */
	let textElementStart = 0 <= startOffset ? startOffset : getTextElementStart(node),
	...
	textElements.forEach((textElement) => {
		 ...
		 */
		if (0 < descendantTagPositions.length) {
