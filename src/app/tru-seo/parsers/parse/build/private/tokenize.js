import { Heading, Paragraph } from '@/app/tru-seo/parsers/parse/structure'
import getTextElementPositions from './getTextElementPositions'
import { hashedHtmlEntities } from '@/app/tru-seo/helpers/htmlEntities'
...
function tokenize (tree, languageProcessor) {
	if ((tree instanceof Paragraph && 'p-overarching' !== tree.name) || tree instanceof Heading) {
