...
class Assessment {
	 ...
	 *
	 * @param {ParsedPaper} _parsedPaper The parsedPaper to check.
	 *
	 ...
	 * @abstract
	 */
	async isApplicable (_parsedPaper) { // eslint-disable-line no-unused-vars
	 ...
	 * @abstract
	 */
	async apply (_parsedPaper) { // eslint-disable-line no-unused-vars
