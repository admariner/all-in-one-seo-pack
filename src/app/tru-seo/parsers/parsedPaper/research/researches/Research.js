...
class Research {
	 ...
	 *
	 * @param {module:parsedPaper/structure.Node} _node The node to calculate the research for.
	 * @param {module:parsedPaper/structure.Node} _metadata The document's metadata.
	 *
	 * @returns {Promise<*>} The result of the research.
	 *
	 * @abstract
	 */
	calculateFor (_node, _metadata) { // eslint-disable-line no-unused-vars
