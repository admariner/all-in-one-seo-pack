...
import { forEach, isNumber, isObject, isUndefined } from '@/app/tru-seo/helpers'
...
class AssessorPresenter {
	...
	configHasProperty (property) {
		return Object.prototype.hasOwnProperty.call(this.presenterConfig, property)
	}
	...
	getUndefinedScores (results) {
		return results.filter(function (result) {
			return isUndefined(result.score) || 0 === result.score
		})
	}
	...
	bindMarkButtons (scores) {
		...
		forEach(scores, function (score) {
			if (Object.prototype.hasOwnProperty.call(score, 'marker')) {
	...
	renderIndividualRatings () {
		// Noop. Subclasses (post-scraper.js, term-scraper.js) override this method.
	}
