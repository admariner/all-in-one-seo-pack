 ...
 * Double quotes are the standard, but we convert these to single quotes when parsing the HTML.
 * Here, we change them back to double quotes by parsing the HTML and then outputting it again.
