 ...
 * @returns {MatchResult} Object containing the number of the matches and the matched tokens.
 */
const matchWordFormsWithSentence = (sentence, wordForms, locale, matchWordCustomHelper, useExactMatching, customSplitIntoTokensHelper) => {
	/*
