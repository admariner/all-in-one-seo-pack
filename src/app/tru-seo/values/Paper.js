 ...
 * 		   slug: string, locale: string, permalink: string, date: string, customData: object,
...
export default class Paper {
	 ...
	 * @param {Array|null}  [attributes.additionalKeywords] The additional keywords or keyphrases of the text.
	 ...
	 * @param {string}  [attributes.postTitle]          The raw post title (the visible title, rendered as the page's H1 on most themes).
	...
	/**
	 * Checks whether additional keywords are available.
	 * @returns {boolean} Returns true if the Paper has additional keywords.
	 */
	hasAdditionalKeywords () {
		return null !== this._attributes.additionalKeywords
	}

	/**
	 * Returns the associated additional keywords or an empty array if no additional keywords are available.
	 * @returns {Array|null} Returns additional keywords.
	 */
	getAdditionalKeywords () {
		return this._attributes.additionalKeywords
	}
	...
	/**
	 * Checks whether a raw post title is available.
	 * @returns {boolean} Returns true if the Paper has a non-empty post title.
	 */
	hasPostTitle () {
		return '' !== this._attributes.postTitle && !isNil(this._attributes.postTitle)
	}

	/**
	 * Returns the raw post title, or an empty string if none is available.
	 * @returns {string} Returns the post title.
	 */
	getPostTitle () {
		return this._attributes.postTitle
	}
