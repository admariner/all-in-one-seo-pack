 ...
 * This is a research for the Word Complexity assessment.
 *
...
export default function wordComplexity (paper, researcher) {
	...
	results = sentences.map(sentence => getComplexWords(sentence, researcher, topicForms))

	// Remove sentences without complex words.
	results = results.filter(result => 0 !== result.complexWords.length)
