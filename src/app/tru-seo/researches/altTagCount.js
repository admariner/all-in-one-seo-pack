...
import imageAltAttribute from '@/app/tru-seo/languageProcessing/helpers/image/getAltAttribute'
import { findTopicFormsInString } from '@/app/tru-seo/languageProcessing/helpers/match/findKeywordFormsInString'
import { isEmpty } from 'lodash-es'
import getImagesInTree from '@/app/tru-seo/languageProcessing/helpers/image/getImagesInTree'
...
const matchAltProperties = function (imageNodes, topicForms, locale, matchWordCustomHelper) {
	...
	imageNodes.forEach(imageNode => {
		...
		if (50 <= keywordMatchedInAltTag.percentWordMatches) {
