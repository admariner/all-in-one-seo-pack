import wordCount from '@/app/tru-seo/languageProcessing/helpers/word/countWords.js'
import removeHtmlBlocks, { IGNORED_CLASSES } from '@/app/tru-seo/languageProcessing/helpers/html/htmlParser'
...
export default function (paper) {
	...
	const customIgnoredClasses = IGNORED_CLASSES.filter(c => 'aioseo-ai-summarize' !== c)
