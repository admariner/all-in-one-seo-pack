...
import {
	...
	sortProminentWords
} from '@/app/tru-seo/languageProcessing/helpers/prominentWords/determineProminentWords'
import { getSubheadingsTopLevel, removeSubheadingsTopLevel } from '@/app/tru-seo/languageProcessing/helpers/html/getSubheadings'
import baseStemmer from '@/app/tru-seo/languageProcessing/helpers/morphology/baseStemmer'
import removeURLs from '@/app/tru-seo/languageProcessing/helpers/sanitize/removeURLs.js'
import removeEmailAddresses from '@/app/tru-seo/languageProcessing/helpers/sanitize/removeEmailAddresses'
...
function getProminentWordsForInternalLinking (paper, researcher) {
	...
	if (customCountLength) {
		if (200 > customCountLength(text)) {
			return result
		}
	} else if (100 > countWords(text)) {
		return result
	}
