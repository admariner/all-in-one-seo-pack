...
import { stripFullTags as stripHTMLTags } from '@/app/tru-seo/languageProcessing/helpers/sanitize/stripHTMLTags.js'
import Sentence from '@/app/tru-seo/languageProcessing/values/Sentence.js'
...
export default function getPassiveVoice (paper, researcher) {
	...
	if ('periphrastic' === passiveType) {
		return getPeriphrasticPassives(paper, researcher)
	}
	if ('morphological' === passiveType) {
