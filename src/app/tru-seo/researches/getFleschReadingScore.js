...
import stripNumbers from '@/app/tru-seo/languageProcessing/helpers/sanitize/stripNumbers.js'
import countSentences from '@/app/tru-seo/languageProcessing/helpers/sentence/countSentences.js'
import countWords from '@/app/tru-seo/languageProcessing/helpers/word/countWords.js'
import countSyllables from '@/app/tru-seo/languageProcessing/helpers/syllables/countSyllables.js'
...
function getConfiguration (researcher) {
	...
	return languageSpecificConfig || defaultConfig
}
...
export default function (paper, researcher) {
	...
	// A score of -1 signals to the code down the line that no valid FRE was calculated.
	if (1 > numberOfSentences || 10 >= numberOfWords) {
		return {
			score      : -1,
			difficulty : DIFFICULTY.NO_DATA
		}
