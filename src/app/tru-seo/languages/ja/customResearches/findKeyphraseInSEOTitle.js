...
import { findWordFormsInString } from '@/app/tru-seo/languageProcessing/helpers/match/findKeywordFormsInString'
import wordMatch from '@/app/tru-seo/languageProcessing/helpers/match/matchTextWithArray'
...
export default function (paper, researcher) {
	...
	if (100 === separateWordFormsMatched.percentWordMatches) {
		result.allWordsFound = true
