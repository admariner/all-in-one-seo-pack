...
import { flattenSortLength, exceptionListHelpers } from '@/app/tru-seo/languageProcessing'

import stem from './stem'
import { stemTOrDFromEndOfWord } from './stemTOrDFromEndOfWord'
const { checkExceptionListWithTwoStems } = exceptionListHelpers
...
const findStemOnVerbExceptionList = function (morphologyDataNL, stemmedWord) {
	...
	if (doNotStemPrefixException) {
		...
		if (2 < stemmedWordWithoutPrefix.length) {
