...
import { getWords, matchRegularParticiples } from '@/app/tru-seo/languageProcessing'
...
export default function getParticiples (clauseText) {
	...
	return words.filter(word => 0 !== matchRegularParticiples(word, regexes).length || includes(irregularParticiples, word))
}