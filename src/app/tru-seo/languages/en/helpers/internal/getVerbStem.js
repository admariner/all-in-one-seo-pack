...
import { buildFormRule, createRulesFromArrays } from '@/app/tru-seo/languageProcessing'
...
const normalizePrefixed = function (word, verbPrefixes) {
	...
	if (true === verbPrefixes.sevenLetterHyphenPrefixes.test(word)) {
		return {
	...
	if (true === verbPrefixes.sevenLetterPrefixes.test(word)) {
		return {
	...
	if (true === verbPrefixes.fiveLetterHyphenPrefixes.test(word)) {
		return {
	...
	if (true === verbPrefixes.fiveLetterPrefixes.test(word)) {
		return {
	...
	if (true === verbPrefixes.fourLetterHyphenPrefixes.test(word)) {
		return {
	...
	if (true === verbPrefixes.fourLetterPrefixes.test(word)) {
		return {
	...
	if (true === verbPrefixes.threeLetterHyphenPrefixes.test(word)) {
		return {
	...
	if (true === verbPrefixes.threeLetterPrefixes.test(word)) {
		return {
	...
	if (true === verbPrefixes.twoLetterHyphenPrefixes.test(word)) {
		return {
	...
	if (true === verbPrefixes.twoLetterPrefixes.test(word)) {
		return {
	...
	if (true === verbPrefixes.oneLetterPrefixes.test(word)) {
		return {
...
const endsWithIng = function (word) {
	...
	if (1 < vowelCount && 4 < word.length) {
		return 'ing' === word.substring(word.length - 3, word.length)
	}
	return false
}
...
const endsWithEd = function (word) {
	...
	if (1 < vowelCount || (1 === vowelCount && 'e' !== word.substring(word.length - 3, word.length - 2))) {
		return 'ed' === word.substring(word.length - 2, word.length)
	}
	return false
}
